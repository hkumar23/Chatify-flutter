...
class VideoCallScreen extends StatefulWidget {
  VideoCallScreen(this.channel, {super.key});
  var channel;
  @override
  ...
  Future<String?> getToken({required String channelId}) async {
    try {
      final response = await http.get(Uri.parse(
          "https://powerful-red-earthworm.cyclic.app/access_token?channelName=${widget.channel}"));
    ...
    _engine.registerEventHandler(RtcEngineEventHandler(
      ...
      debugPrint(
          '[onTokenPrivilegeWillExpire] connection: ${connection.toJson()}, token: $token');
            ...
            (rtcConnection, remoteUid, videoState, reason, elapsed) {
