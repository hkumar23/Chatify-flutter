            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: NetworkImage(userData[AppConstants.imageUrl]),
                  fit: BoxFit.cover,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Wrap(
                              ...
                              children: [
                                Text(
                                  userData[AppConstants.profession],
                          ...
                          Padding(
                            ...
                            child: FilledButton(
                              ...
                              child: const Text(AppLanguage.message),
                            ),
                          ),
                          Padding(
                            padding: const EdgeInsets.only(
                            ...
                            child: Row(
                              children: [
                                SocialMediaButton(
                                  link: userData[AppConstants.socialMediaLinks]
                          ...
                          Padding(
                            padding: const EdgeInsets.only(
                                left: 30, top: 30, bottom: 20, right: 20),
                            child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(
                                  ...
                                  Text(
                                    userData[AppConstants.techSkills],
                                    style: GoogleFonts.roboto(
                                      fontSize: Theme.of(context)
                                          .textTheme
                                          .bodyLarge!
                                  ...
                                  StreamBuilder(
                                      ...
                                      builder: (context, projectsSnap) {
                                        if (projectsSnap.connectionState ==
                                        ...
                                        final projectDocs =
                                            projectsSnap.data!.docs;
                                        if (projectDocs.isNotEmpty) {
                                          List<ProjectItem> list = [];
                                          for (int i = 0;
                                              i < projectDocs.length;
                                              ++i) {
                                            list.add(ProjectItem(
                                              title:
                                                  "${i + 1}. ${projectDocs[i][AppConstants.title]}",
                                              description: projectDocs[i]
                                                  [AppConstants.description],
                                              projectLink: projectDocs[i]
                                                  [AppConstants.projectLink],
                                            ));
                                          }
                                          return Column(
                                            crossAxisAlignment:
