...
class _AddContactScreenState extends State<AddContactScreen> {
  ...
  void _submit(BuildContext context) async {
    ...
    try {
      await Provider.of<Contacts>(context, listen: false)
          .addContact(email!, currUser!.uid, null);

      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        backgroundColor: Theme.of(context).colorScheme.primary,
        content: const Text(AppLanguage.contactAdded),
      ));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text(AppLanguage.addContact),
      ),
      body: Stack(children: [
        // Container(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            label: const Text(AppLanguage.emailAddress),
